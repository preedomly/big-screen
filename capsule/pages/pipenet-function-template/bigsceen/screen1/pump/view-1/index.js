...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/pages/bigsceen/screen1/pump/view-1/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/pages/bigsceen/screen1/pump/model/index.js":
/*!********************************************************!*\
  !*** ./src/pages/bigsceen/screen1/pump/model/index.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_Formurl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/Formurl */ "./src/pages/bigsceen/screen1/pump/services/Formurl.js");


/* harmony default export */ __webpack_exports__["default"] = ({
  namespace: 'bengzhanspace',
  state: {
    bengzhanData: 0,
    opend: ''
  },
  effects: {
    *getBengzhan({
      ...
      let bengzhanData;
      const response = yield call(_services_Formurl__WEBPACK_IMPORTED_MODULE_1__["getBengzhan"], payload);
      console.log(response);
      bengzhanData = response.result;
      yield put({
        type: 'ztbengzhanData',
        payload: bengzhanData
      });
    }

  },
  reducers: {
    ztbengzhanData(state, {
      payload
    }) {
      return _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_0___default()({}, state, {
        pumpingstation: payload
      });
    }
...
/***/ "./src/pages/bigsceen/screen1/pump/services/Formurl.js":
/*!*************************************************************!*\
  !*** ./src/pages/bigsceen/screen1/pump/services/Formurl.js ***!
  \*************************************************************/
/*! exports provided: getBengzhan */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBengzhan", function() { return getBengzhan; });
...
async function getBengzhan(params) {
...
/***/ "./src/pages/bigsceen/screen1/pump/view-1/View.js":
/*!********************************************************!*\
  !*** ./src/pages/bigsceen/screen1/pump/view-1/View.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _style_index_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style/index.less */ "./src/pages/bigsceen/screen1/pump/view-1/style/index.less");
...
let _class = (_dec = Object(pipenet_core_lib_react__WEBPACK_IMPORTED_MODULE_1__["connect"])(state => ({
  pumpingstation: state.bengzhanspace.pumpingstation
  ...
  constructor(...args) {
    ...
    this.query = () => {
      const payload = {};
      this.props.dispatch({
        type: 'bengzhanspace/getBengzhan',
        payload
      });
    };
  }
  ...
  componentDidMount() {
    this.query(); // $.ecity.dialog.message('message', 3000, 200, 400);
  ...
  render() {
    ...
    console.log(555666);
    console.log(pumpingstation);

    if (pumpingstation == undefined) {
      return null;
    } else {
      var arr1 = [];
      var arr2 = [];
      var arr3 = [];
      var arr4 = [];
      pumpingstation.forEach((item, index) => {
      ...
      arr1.forEach((item, index) => {
        arr3.push(JSON.parse(item.data));
        console.log(JSON.parse(item.data));
      });
      arr2.forEach((item, index) => {
        arr4.push(JSON.parse(item.data));
      });
      console.log(arr3[1].Data[0].Rs[0].R[0].C);
      return (// <div className="main">
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.pumpingStation
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.yunxing,
          style: {
          ...
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.bzbeijin
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.psone,
          style: {
            borderImage: "url('/images/imgs/onescreen/泵站.png') 0 0 0 0 fill round",
            borderImageRepeat: "stretch"
          }
        }, item.name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.condition
          ...
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.stop
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          style: {
            borderImage: "url('/images/imgs/onescreen/状态-运行.png') 0 0 0 0 fill round",
            borderImageRepeat: "stretch"
          }
          ...
          style: {
            borderImage: "url('/images/imgs/onescreen/状态-预警.png') 0 0 0 0 fill round",
            borderImageRepeat: "stretch"
          }
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, "2#")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.stop
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          style: {
            borderImage: "url('/images/imgs/onescreen/状态-停止.png') 0 0 0 0 fill round",
            borderImageRepeat: "stretch"
          }
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, "3#")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.stop
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          style: {
            borderImage: "url('/images/imgs/onescreen/状态-运行.png') 0 0 0 0 fill round"
          }
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, "4#")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.stop
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          style: {
            borderImage: "url('/images/imgs/onescreen/状态-运行.png') 0 0 0 0 fill round"
          }
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, "5#")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.stop
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          style: {
            borderImage: "url('/images/imgs/onescreen/状态-运行.png') 0 0 0 0 fill round"
          }
        }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, "6#"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.jindu
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.shunshi
        ...
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_3__["Progress"], {
          showInfo: false,
          percent: (arr3[index].Data[0].Rs[0].R[2] == undefined || arr3[index].Data[0].Rs[0].R[2].C == -0 ? 625.30 : arr3[index].Data[0].Rs[0].R[2].C.slice(0, 6)) / 30.0,
          strokeWidth: 8
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.Time
        }, arr3[index].Data[0].Rs[0].R[2] == undefined || arr3[index].Data[0].Rs[0].R[2].C == -0 ? 625.30 : arr3[index].Data[0].Rs[0].R[2].C.slice(0, 5), " \xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "m\xB3/\u5C0F\u65F6"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.jindu
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.shunshi
          ...
          showInfo: false,
          percent: arr3[index].Data[0].Rs[0].R[1].C == 0 ? 0.0262 : arr3[index].Data[0].Rs[0].R[1].C.slice(0, 6) / 0.05,
          strokeWidth: 8
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.Time
        }, arr3[index].Data[0].Rs[0].R[1].C == 0 ? 0.0262 : arr3[index].Data[0].Rs[0].R[1].C.slice(0, 6), " \xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Mpa"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.jindu
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.shunshi
          ...
          showInfo: false,
          percent: arr3[index].Data[0].Rs[0].R[0].C.slice(0, 6) / 0.05,
          strokeWidth: 8
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.Time
          ...
          showInfo: false,
          percent: (arr4[index].Data[0].Rs[0].R[2] == undefined || arr4[index].Data[0].Rs[0].R[2].C == 0 ? 725.4 : arr4[index].Data[0].Rs[0].R[2].C.slice(0, 6)) / 30.0,
          strokeWidth: 8
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.Time
        }, arr4[index].Data[0].Rs[0].R[2] == undefined || arr4[index].Data[0].Rs[0].R[2].C == 0 ? 725.4 : arr4[index].Data[0].Rs[0].R[2].C.slice(0, 5), " \xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "m\xB3/\u5C0F\u65F6"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.jindu
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.shunshi
        }, "\u538B\u529B"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          showInfo: false,
          percent: arr4[index].Data[0].Rs[0].R[1].C == 0 ? 0.0214 : arr4[index].Data[0].Rs[0].R[1].C.slice(0, 6) / 0.05,
          strokeWidth: 8
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.Time
        }, arr4[index].Data[0].Rs[0].R[1].C == 0 ? 0.0214 : arr4[index].Data[0].Rs[0].R[1].C.slice(0, 6), "\xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Mpa"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.jindu
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.shunshi
        }, "\u6DB2\u4F4D"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          showInfo: false,
          percent: arr4[index].Data[0].Rs[0].R[0].C == 0 ? 2.8523 : arr4[index].Data[0].Rs[0].R[0].C.slice(0, 6) / 0.05,
          strokeWidth: 8
        }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: _style_index_less__WEBPACK_IMPORTED_MODULE_2___default.a.Time
...
/***/ "./src/pages/bigsceen/screen1/pump/view-1/index.js":
/*!*********************************************************!*\
  !*** ./src/pages/bigsceen/screen1/pump/view-1/index.js ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _View__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./View */ "./src/pages/bigsceen/screen1/pump/view-1/View.js");
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model */ "./src/pages/bigsceen/screen1/pump/model/index.js");
...
/***/ "./src/pages/bigsceen/screen1/pump/view-1/style/index.less":
/*!*****************************************************************!*\
  !*** ./src/pages/bigsceen/screen1/pump/view-1/style/index.less ***!
  \*****************************************************************/
/*! no static exports found */
